...
def chatterbox_target_status(device, *, system=None, architecture=None):
    ...
    return {
        ...
        "error": None if supported else (
            "Chatterbox supports Linux x86_64/amd64 CPU only; "
...
default_engine_settings = {
    ...
    TTS_ENGINES['CHATTERBOX']: {
        ...
        "voice": None,
        "voices": {},
        "notice": "Chatterbox V2/V3 plus Turbo/Nano — V2/V3 support 23 languages; Turbo/Nano are English-only — CPU-only — isolated Python 3.11 runtime — Linux x86_64/amd64. V2 remains the default. Audio includes an imperceptible Perth watermark; Chatterbox and Perth are MIT-licensed.",
